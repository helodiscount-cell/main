...
export default function ClaimPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#F1F1F1] p-4 font-sans">
      <div className="w-full max-w-xl bg-white rounded-[32px] shadow-xl overflow-hidden animate-in fade-in zoom-in duration-500">
        <div className="p-8 md:p-12 space-y-8 flex flex-col items-center">
          ...
          <div className="w-full space-y-4 pt-4">
            ...
            <button
              ...
              className="w-full group p-5 bg-white border-2 border-gray-100 rounded-2xl flex items-center text-left hover:border-purple-500 hover:shadow-md transition-all duration-300 transform hover:-translate-y-1"
            >
            ...
            <Link
              href="/dash"
              className="w-full group p-5 bg-white border-2 border-gray-100 rounded-2xl flex items-center text-left hover:border-blue-500 hover:shadow-md transition-all duration-300 transform hover:-translate-y-1"
            >
