  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-4">
        <div className="w-10 h-10 rounded-lg bg-[#F5F3FF] flex items-center justify-center text-[#6A06E4] group-hover:bg-[#6A06E4] group-hover:text-white transition-colors duration-300    -sm border border-[#E9E4FF]">
          <Layers size={18} />
        </div>
