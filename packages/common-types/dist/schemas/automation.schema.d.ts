...
export declare const CreateAutomationSchema: z.ZodObject<
  {
    triggerType: z.ZodDefault<
      z.ZodEnum<{
        ...
        RESPOND_TO_ALL_DMS: "RESPOND_TO_ALL_DMS";
      }>
    >;
    automationName: z.ZodPipe<z.ZodString, z.ZodTransform<string, string>>;
